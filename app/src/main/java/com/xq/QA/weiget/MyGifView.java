...
public class MyGifView extends View {
    ...
    private void setViewAttributes(Context context, AttributeSet attrs,
        ...
        final TypedArray array = context.obtainStyledAttributes(attrs,
                R.styleable.XNGifMoviewView, defStyle, R.style.Widget_MyGiftView);
        mGiftId = array.getResourceId(R.styleable.XNGifMoviewView_gif, -1);
        mPaused = array.getBoolean(R.styleable.XNGifMoviewView_paused, false);
        array.recycle();
        if (mGiftId != -1) {
